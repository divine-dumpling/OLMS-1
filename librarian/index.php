                ...
                <div class="card col-md-12">
                    ...
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php
                                $query = mysqli_query($conn, "SELECT DISTINCT issued_book.book_id, books.book_name FROM issued_book INNER JOIN books ON books.id = issued_book.book_id WHERE return_date = ''");
                                $i = 0;
                                while ($result = mysqli_fetch_assoc($query)):
                                    $id = $result['book_id'];
                                    $query1 = mysqli_query($conn, "SELECT COUNT(book_id) as total FROM issued_book WHERE book_id = '$id' && return_date = '' ");
