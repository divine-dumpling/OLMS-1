            ...
            if($username_check == 0)
            {
                if(strlen($user_name) >= 6){
                    if(strlen($password) >= 8){
						...
						$sql = "INSERT INTO students(`fname`, `lname`, `department_id`, `roll`, `usn`, `email`, `user_name`, `password`, `phone_no`, `status`) VALUES ('$f_name', '$l_name', '$department','$roll','$usn','$email', '$user_name', '$password_hash', '$phone_no', '0')";
