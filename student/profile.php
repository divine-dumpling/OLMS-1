                    ...
                    <form action="include/edit_function.php" method="POST" enctype="multipart/form-data" data-parsley-validate>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <tr>
                                ...
                                <td><input type="text" name="fname" class="form-control" value="<?= $student_info['fname']?>" required="" data-parsley-trigger="change focusout" data-parsley-required-message = "First Name is required" autocomplete="off"></td>
                            </tr>
                            <tr>
                                <th class="w-25">Last Name</th>
                                <td><input type="text" name="lname" class="form-control" value="<?= $student_info['lname'] ?>" required="" data-parsley-trigger="change focusout" data-parsley-required-message = "Last Name is required" autocomplete="off"></td>
                            </tr>
                            <tr>
...
<!--                                            <option value="--><?//= $result['id']?><!--">--><?//= $result['department_name']?><!--</option>-->
                            ...
                            <tr>
                                <th class="w-25">USN</th>
                                <td><input type="text" name="usn" class="form-control" value="<?= $student_info['usn'] ?>" required="" data-parsley-trigger="change focusout" data-parsley-required-message = "USN is required" autocomplete="off"></td>
                            </tr>
                            <tr>
